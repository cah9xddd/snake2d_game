...
{
    if (Init(game_title, x, y, w, h, fullscreen))
    {
...
bool SDLManager::Init(const char *game_title = "Game", int x = SDL_WINDOWPOS_CENTERED, int y = SDL_WINDOWPOS_CENTERED, int w = 1280, int h = 720, bool fullscreen = true)
{
